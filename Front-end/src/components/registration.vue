      ...
      <b-row>
        <b-col>
          <b-navbar toggleable="md" type="dark" variant="danger" fixed="top">
            ...
            <b-navbar-nav>
              <router-link :to="{ path: '/' }"><b-button size="sm" class="my-2 my-sm-0" type="submit">Search</b-button></router-link>
        ...
        <b-col>
          <div class="fullRegistrationForm">
            ...
            <b-form @submit="onSubmit" @reset="onReset" v-if="show">
              ...
              <b-button type="reset" variant="danger">Сбросить введенные данные</b-button>
    </b-form>
  </div>
</b-col>
        <b-col>2 of 2</b-col>
